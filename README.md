UPLINK PROJECT - PYTHON
python_project_uplink
Python project for uplink calculations (with documentation PDF)

Uplink Link Budget Calculator (Python)
...
Repository contents
Uplink.py — main Python script (uplink calculations)
Uplink_report.pdf — report/documentation (Greek)
How to run
Requirements
Python 3.x
Run
Open a terminal in the repository folder and execute: bash python Uplink.py
